...
export class LoginComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private ServiceUser: UsersService, private router: Router, private currentUserService: CurrentUserService ,private socialAuthService: SocialAuthService,) { }
  ngOnInit(): void {
